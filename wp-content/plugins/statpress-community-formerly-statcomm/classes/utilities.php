...
*/
 class utilities
 {
     ...
     const PLUGIN_VERSION   = "v1.7.50";
     const UAPARSER_URL     = 'http://statcommzzzz.wpgetready.com/statservice/getfile';
     const UAPARSER_VERSION = 'http://statcommzzzz.wpgetready.com/statservice/version';
     const UAPARSER_MD5     = 'http://statcommzzzz.wpgetready.com/statservice/md5';
     const TIMEOUT =10;
...
//Constants used in viewSystem
    ...
    */
     ...
     */
    static public function makeQuery($aColumns,$sIndexColumn, $sTable)
    {
        /* Paging  */
        $sLimit = "";
