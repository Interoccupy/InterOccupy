...
I personally appreciate your opinion on this plugin.
Please vote it or even better, <a href='https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=KZPB2M355392Q' target='_blank'>make a donation</a>.
All the money is rerouted to <a href='http://wpgetready.com/project-donations/'>other projects</a> which made Statcomm possible.

Is it anything to complain? Drop a note on the forum(s) about what would you like to be improved/fixed.
...
= Version 1.7.50: What is in it for you?
 * My collegue Sergei will continue working in some other areas, so I will manage the whole plugin from now on.
 * Extended the template system to allow javascript and css run independent for each module.
...
Improved handling error for Multibyte String extension not installed.
Improved handling error for safe_ini settings
Added modifications for next Ajax interface.