...
//        $sTable = "#table#"; //Will be replaced with prefix_statcomm table
        ...
        //Build the query.
        //Tested sQuery is NOT and for that it will be discarded
        $sQuery= utilities::makeQuery($aColumns,$sIndexColumn,$sTable);
        try
        {
        ...
        utilities::fl("NEW JSON:" , json_encode($output));
...
*/
    ...
    public function rows($Query)
    {
        ...
        $output["iTotalDisplayRecords"] = $counter;
        return $output;
    }
